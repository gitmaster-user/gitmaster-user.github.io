...
async function main() {
  if (window.location.hash) {
    ...
    try {
      ...
      document.querySelector("#no-redirect").href = `https://gitmaster-user.github.io/prelock/decrypt/#${hash}`;

      // Set the "create hidden bookmark" URL appropriately
      document.querySelector("#hidden").href = `https://gitmaster-user.github.io/prelock/hidden/#${hash}`;
      return;
    }
